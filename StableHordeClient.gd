...
# 	stable_horde_client.connect("request_initiated", Callable(model, "_on_request_initiated"))
# 	# warning-ignore:return_value_discarded
# 	stable_horde_client.connect("images_generated", Callable(self, "_on_images_generated"))
# 	# warning-ignore:return_value_discarded
# 	stable_horde_client.connect("request_failed", Callable(self, "_on_request_failed"))
# 	# warning-ignore:return_value_discarded
# 	stable_horde_client.connect("request_warning", Callable(self, "_on_request_warning"))
# 	# warning-ignore:return_value_discarded
# 	stable_horde_client.connect("image_processing", Callable(self, "_on_image_process_update"))
# 	# warning-ignore:return_value_discarded
# 	img_2_img_enabled.connect("toggled", Callable(self, "on_img2img_toggled"))
# 	# warning-ignore:return_value_discarded
# 	select_image.connect("image_selected", Callable(self, "_on_source_image_selected"))
# 	# warning-ignore:return_value_discarded
# 	EventBus.connect("kudos_calculated", Callable(self, "_on_kudos_calculated"))
# 	EventBus.connect("cache_wipe_requested", Callable(self, "_on_cache_wipe_requested"))
# 	stable_horde_client.client_agent = "Lucid Creations:" + ToolConsts.VERSION + ":(discord)db0#1625"
# 	stable_horde_client.aihorde_url = SettingsManager.aihorde_url

# 	_connect_hover_signals()
# 	# warning-ignore:return_value_discarded
# 	save.connect("pressed", Callable(self, "_on_save_pressed"))
# 	# warning-ignore:return_value_discarded
# 	save_all.connect("pressed", Callable(self, "_on_save_all_pressed"))
# 	load_from_disk.connect("gensettings_loaded", Callable(self, "_on_load_from_disk_gensettings_loaded"))
# 	# warning-ignore:return_value_discarded
...
# 	# warning-ignore:return_value_discarded
# 	model.connect("prompt_inject_requested", Callable(self, "_on_prompt_inject"))
# 	# warning-ignore:return_value_discarded
# 	lora.connect("prompt_inject_requested", Callable(self, "_on_prompt_inject"))
# 	# warning-ignore:return_value_discarded
# 	ti.connect("prompt_inject_requested", Callable(self, "_on_prompt_inject"))
# 	# Ratings
# 	# warning-ignore:return_value_discarded
# 	EventBus.connect("shared_toggled", Callable(self, "_on_shared_toggled"))
# 	# warning-ignore:return_value_discarded
# 	best_of.connect("toggled", Callable(self, "on_bestof_toggled"))
# 	# warning-ignore:return_value_discarded
# 	aesthetic_rating.connect("item_selected", Callable(self, "on_aethetic_rating_selected"))
# 	# warning-ignore:return_value_discarded
# 	artifacts_rating.connect("item_selected", Callable(self, "on_artifacts_rating_selected"))
# 	# warning-ignore:return_value_discarded
# 	submit_ratings.connect("pressed", Callable(self, "_on_submit_ratings_pressed"))
# 	# warning-ignore:return_value_discarded
# 	stable_horde_rate_generation.connect("generation_rated", Callable(self, "_on_generation_rated"))
# 	# warning-ignore:return_value_discarded
# 	stable_horde_rate_generation.connect("request_failed", Callable(self, "_on_generation_rating_failed"))
# 	nsfw.connect("toggled", Callable(self, "_on_nsfw_toggled"))
# 	_on_shared_toggled()
# 	_check_html5()
...
# 	karras.button_pressed = stable_horde_client.karras
# 	hires_fix.button_pressed = stable_horde_client.hires_fix
# 	negative_prompt.button_pressed = globals.config.get_value("Options", "negative_prompt", false)
# 	nsfw.button_pressed = stable_horde_client.nsfw
# 	censor_nsfw.button_pressed = stable_horde_client.censor_nsfw
...
# 	status_text.text = "[color=green]Your images are ready![/color]"
...
# 		status_text.text = "Thank you for using the AI Horde! "\
...
# 		status_text.text = "The Horde appears to be under heavy load at the moment! Your queue position is {queue}. ".format({"queue":stats.queue_position})\
...
# 	else:
# 		status_text.text = "Your queue position is {queue}.".format({"queue":stats.queue_position})
# 		status_text.modulate = Color(0,1,0)
...
# 	if tr_min_size.x > grid_scroll.custom_minimum_size.x:
# 		tr_min_size.x = grid_scroll.custom_minimum_size.x
# 	if tr_min_size.y > grid_scroll.custom_minimum_size.y:
# 		tr_min_size.y = grid_scroll.custom_minimum_size.y
# 	return(tr_min_size)
...
# 	negative_prompt.button_pressed = pressed
...
# 		status_text.text = "It appears you have enterred a negative prompt. Please use the negative prompt textbox"
# 		status_text.modulate = Color(1,1,0)
...
# 		$"%ShowAllWorkers",
# 	]:
# 		node.connect("mouse_entered", Callable(EventBus, "_on_node_hovered").bind(node))
# 		node.connect("mouse_exited", Callable(EventBus, "_on_node_unhovered").bind(node))
...
# #	print_debug(stats)
# 	status_text.modulate = Color(0,1,0)
# 	status_text.text = "Thank for you rating your images. You have received a refund of {kudos} kudos.".format({"kudos":kudos})
...
# 	karras.button_pressed = settings.get("karras", true)
# 	hires_fix.button_pressed = settings.get("hires_fix", false)
...
# 			img_2_img_enabled.button_pressed = true
# 	else:
# 		on_img2img_toggled(false)
# 		img_2_img_enabled.button_pressed = false
# 		stable_horde_client.source_image = null
# 		stable_horde_client.control_type = "none"
...
# 		fmt["color"] = "#FFA500"
# 	kudos_text.text = "[color={color}]Kudos: {kudos}[/color]".format(fmt)
