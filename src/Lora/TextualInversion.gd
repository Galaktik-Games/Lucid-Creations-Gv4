...
func _ready():
	...
	ti_reference_node.nsfw = SettingsManager.get_setting("nsfw")
	...
	ti_info_card.connect("popup_hide", Callable(self, "_on_ti_info_card_hide"))
	...
	selected_tis_list = SettingsManager.get_setting("tis")
